...
\]
\end{theorem}
\textbf{Proof} We are going to mimick the proof of the semicircle law as much as possible. The $X_j$  are iid and we can write their moments as
\[
...
\hline
  \{1\}, \{2\}  & \ensuremath{\bbE}[X_{i_1} X_{i_2}] = \ensuremath{\mu}_1^2  = 0  & n(n-1) = n^2 + O(n)\\
  \{1,2\}  & \ensuremath{\bbE} X_{i_1}^2 = \ensuremath{\mu}_1^2 = 1 &  n
\end{array}
\]
...
&\qquad  + n^{-2} \ensuremath{\sum}_{\hbox{parititions with 4 elements}} \underbrace{n}_{\hbox{terms per partition}}    \ensuremath{\mu}_4 \\
&=
