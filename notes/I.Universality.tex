...
\]
\end{theorem}
\textbf{Proof} We begin with the case of $k=2m$ even, where
\meeq{
\ensuremath{\bm{\mathrm{E}}}\br[(A_n/\sqrt{n})^{2m}] = n^{-m} \ensuremath{\bm{\mathrm{E}}}\br[\ensuremath{\sum}_{i_1,\ensuremath{\ldots},i_{2m} = 1}^n a_{i_1 i_2} a_{i_2 i_3} \ensuremath{\cdots} a_{i_{2m} i_1}] \ccr
= n^{-m} \ensuremath{\sum}_{i_1,\ensuremath{\ldots},i_{2m} = 1}^n \ensuremath{\bm{\mathrm{E}}}[a_{i_1 i_2} a_{i_2 i_3} \ensuremath{\cdots} a_{i_{2m} i_1}].
}
Let's look at some low order cases beginning with $m = 1$. Here we have using symmetry $a_{kj} = a_{jk}$ and $\ensuremath{\bm{\mathrm{E}}}[a_{kj}^2 = 1$:
\meeq{
\ensuremath{\bm{\mathrm{E}}}\br[(A_n/\sqrt{n})^2] = {1 \over n^2} \ensuremath{\sum}_{k,j=1}^n \ensuremath{\bm{\mathrm{E}}}[a_{kj} a_{jk}] \ccr
{1 \over n^2} \ensuremath{\sum}_{k,j=1}^n \ensuremath{\bm{\mathrm{E}}}[a_{kj}^2] = 1.
}
For $m = 2$ we have:
\meeq{
\ensuremath{\bm{\mathrm{E}}}\br[(A_n/\sqrt{n})^4] = {1 \over n^3} \ensuremath{\sum}_{i_1,i_2,i_3,i_4}^n \ensuremath{\bm{\mathrm{E}}}[a_{i_1i_2}a_{i_2i_3}a_{i_3i_4}a_{i_4i_1}]
}
Note because of independence ($\ensuremath{\bm{\mathrm{E}}}[a_{i_1i_2}] = 0$), the only terms that remain are those where $a_{i_1i_2}$ and $a_{i_2i_1}$ together appear at least twice. thus this sum reduces to:
\[
\ensuremath{\bm{\mathrm{E}}}\br[(A_n/\sqrt{n})^4] = {1 \over n^3} \ensuremath{\sum}_{k=1}^n \ensuremath{\bm{\mathrm{E}}}[a_{kk}^4]
\]
\ensuremath{\QED}
